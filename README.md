...
* Use `Pymongo` for CRUD applications for your database. For this homework, simply overwrite the existing document each time the `/scrape` url is visited and new data is obtained.
